...
/* ----------------------  nRF51 Specific Interrupt Numbers  ---------------------- */
  ...
  WUCOMP_COMP_IRQn              =  19,              /*!<  19  WUCOMP_COMP                                                      */
...
typedef struct {                                    /*!< CLOCK Structure                                                       */
  ...
  __IO uint32_t  HFCLKSTAT;                         /*!< High frequency clock status.                                          */
  __I  uint32_t  RESERVED4[2];
  __IO uint32_t  LFCLKSTAT;                         /*!< Low frequency clock status.                                           */
...
typedef struct {                                    /*!< RTC Structure                                                         */
  ...
  __IO uint32_t  EVTEN;                             /*!< Configures event enable state for each RTC event.                     */
  __IO uint32_t  EVTENSET;                          /*!< Enable events. The reading of this register gives the value
                                                         of EVTEN.                                                             */
  __IO uint32_t  EVTENCLR;                          /*!< Disable events. The reading of this register gives the value
                                                         of EVTEN.                                                             */
...
typedef struct {                                    /*!< WDT Structure                                                         */
  ...
  __IO uint32_t  INTENCLR;                          /*!< Interrupt enable clear register.                                      */
  __I  uint32_t  RESERVED2[61];
  __IO uint32_t  RUNSTATUS;                         /*!< Watchdog running status.                                              */
  __IO uint32_t  REQSTATUS;                         /*!< Request status.                                                       */
  __I  uint32_t  RESERVED3[63];
...
/**
  * @brief Wakeup Comparator. (WUCOMP)
  */

typedef struct {                                    /*!< WUCOMP Structure                                                      */
  ...
  __I  uint32_t  RESERVED0[61];
  __IO uint32_t  EVENTS_READY;                      /*!< WUCOMP is ready and output is valid.                                  */
  ...
  __I  uint32_t  RESERVED1[60];
  __IO uint32_t  SHORTS;                            /*!< Shortcut for the WUCOMP.                                              */
  __I  uint32_t  RESERVED2[64];
  __IO uint32_t  INTENSET;                          /*!< Interrupt enable set register.                                        */
  __IO uint32_t  INTENCLR;                          /*!< Interrupt enable clear register.                                      */
  __I  uint32_t  RESERVED3[61];
  ...
  __I  uint32_t  RESERVED4[63];
  __IO uint32_t  ENABLE;                            /*!< Enable the WUCOMP.                                                    */
...
#define NRF_WUCOMP_BASE                 0x40013000UL
...
#define NRF_WUCOMP                      ((NRF_WUCOMP_Type         *) NRF_WUCOMP_BASE)
