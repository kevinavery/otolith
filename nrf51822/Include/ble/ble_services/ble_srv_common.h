...
#define BLE_UUID_CGM_SERVICE                                     0x181A     /**< TEMPORARY Continuous Glucose Meter service UUID*/
/** @} */
...
#define CGM_MEASUREMENT_CHAR                                     0x2A6C     /**< CGM Measurement characteristic UUID. */
#define CGM_FEATURES_CHAR                                        0x2A6D     /**< CGM Features characteristic UUID. */
#define CGM_STATUS_CHAR                                          0x2A6E     /**< CGM Status characteristic UUID. */
#define CGM_SESSION_START_TIME_CHAR                              0x2A6F     /**< CGM Session Start Time characteristic UUID. */
#define CGM_APPLICATION_SECURITY_POINT_CHAR                      0x2A70     /**< Application Security Pointcharacteristic UUID. */
#define CGM_SPECIFIC_OPS_CONTROL_POINT_CHAR                      0x2A71     /**< CGM Specific Ops Control Point characteristic UUID. */
/** @} */
...
/**@brief Inline function for decoding a CCCD value, and then testing if notification is
 *        enabled.
 *
...
/**@brief Inline function for decoding a CCCD value, and then testing if indication is
 *        enabled.
 *
 * @param[in]   p_encoded_data   Buffer where the encoded CCCD is stored.
 *
...
/**@brief Encode a Report Reference Descriptor.
 *
...
/**@brief Make UTF-8 structure refer to an ASCII string.
 *
